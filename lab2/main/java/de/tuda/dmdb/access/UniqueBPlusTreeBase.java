...
public abstract class UniqueBPlusTreeBase<T extends AbstractSQLValue>
    extends AbstractDynamicIndex<T> {
  // constants
  ...
  protected Map<Integer, AbstractIndexElement<T>> indexElements =
      new HashMap<>(); // map (pageNumber, indexElement)
   ...
   */
  protected UniqueBPlusTreeBase(AbstractTable table, int keyColumnNumber, int minFillGrade) {
    super(table);
   ...
   * @param keyColumnNumber Number of unique column which should be indexed
   */
  protected UniqueBPlusTreeBase(AbstractTable table, int keyColumnNumber) {
  ...
  public Map<Integer, AbstractIndexElement<T>> getIndexElements() {
    return indexElements;
  }

  public void setIndexElements(Map<Integer, AbstractIndexElement<T>> indexElements) {
