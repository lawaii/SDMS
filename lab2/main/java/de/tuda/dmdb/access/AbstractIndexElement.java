...
public abstract class AbstractIndexElement<T extends AbstractSQLValue> {
   ...
   */
  public abstract RecordIdentifier lookup(T key);
  ...
  /**
   * Indicate if index element is root or leaf node
   *
   * @return True if index element is a leaf node, otherwise false
   */
